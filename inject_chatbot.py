...
# Make sure we don't inject multiple times if run again
...
<div id="chat-widget">
  ...
  <div id="chat-panel" class="hidden">
    <div id="chat-header">
      <span>🤖 CCNA Bot (Gemini)</span>
      <button id="chat-close">✖</button>
    </div>
    <div id="chat-messages">
      <div class="cmsg bot">Salut ! Je suis ton assistant CCNA virtuel basé sur l'IA <b>Gemini</b>. Pose-moi n'importe quelle question sur le cours ou les exercices !</div>
    </div>
...
<script>
  ...
  chatSend.addEventListener('click', async () => {
    ...
    try {
      ...
      document.getElementById(loadingId)?.remove();
      chatMessages.innerHTML += `<div class="cmsg bot error"><b>Erreur :</b> ${e.message}<br><br>As-tu bien ajouté <code>GEMINI_API_KEY</code> dans les variables d'environnement Vercel ?</div>`;
    }
    chatMessages.scrollTop = chatMessages.scrollHeight;
  });
</script>
